...
/**
 * 检查当前是否为 A 股交易时间
 * 根据需求调整为：每天 09:15 - 15:05 为交易时段，其余时间及周末为非交易时段
 * A 股标准交易时间：周一至周五 9:30-11:30, 13:00-15:00
 * 轮询建议时段（包含集合竞价及尾盘处理）：9:15-11:30, 13:00-15:05
...
export function isTradingTime(): boolean {
	...
	// 早上 9:15 (555) - 11:30 (690)
	const isMorning = totalMinutes >= 555 && totalMinutes <= 690;
	// 下午 13:00 (780) - 15:05 (905)
