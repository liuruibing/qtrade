...
from dvadmin.system.views.dictionary import InitDictionaryViewSet, CurrentDictionaryViewSet
...
urlpatterns = (
        [
            ...
            path("api/selection/", include("dvadmin.selection.urls")),
            ...
            path("api/current/dictionary/", CurrentDictionaryViewSet.as_view()),
...
# ==========================================================
# 暴力兼容: Nginx 转发过来的 /qtrade 前缀无法被 Django 自动去除
# 这里手动将所有路由再注册一份到 /qtrade/ 下
# ==========================================================
base_urlpatterns = list(urlpatterns)
urlpatterns += [
    path('qtrade/', include(base_urlpatterns)),
]
